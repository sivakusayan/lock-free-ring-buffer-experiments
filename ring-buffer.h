...
/**
 * Returns RING_BUFFER_INVALID_ARGS if ring_buffer is null, or if the
 * computed size overflows. Else returns RING_BUFFER_OK, and initializes
 * a ring buffer into the provided memory.
 *
...
/**
 * Returns RING_BUFFER_INVALID_ARGS if either the ring_buffer or item
 * are null pointers.
...
/**
 * Returns RING_BUFFER_INVALID_ARGS if either the ring buffer or item
 * are null pointers.
